  ...
  return (
    <div className="min-h-screen bg-[#faf6ef] text-[#3a2f1f]">
      ...
      <main>
        ...
        {/* ── Hero - La Primavera ──────────────────────────────────────────────
            Botticelli's eternal garden - the inner spring, the awakening soul.
        ──────────────────────────────────────────────────────────────────────── */}
        ...
        {/* ── Opening quote ───────────────────────────────────────────────────
            The key teaching from Samael, set large and prominently.
        ──────────────────────────────────────────────────────────────────────── */}
        ...
        {/* ── Art banner: Bouguereau - Song of the Angels ─────────────────────
            The Divine Mother and angels: peace, illumination, spiritual grace.
        ──────────────────────────────────────────────────────────────────────── */}
        <figure className="overflow-hidden shadow-xl border-y border-[#c8b89a]" aria-label="Artwork">
          <img
            src={artBouguereauImg}
            alt="William-Adolphe Bouguereau's Song of the Angels: the Divine Mother holding the Christ Child, surrounded by angels in rapturous music - an image of the divine peace that awaits the meditating consciousness."
            className="w-full h-72 sm:h-96 object-cover"
            style={{ objectPosition: 'center 15%' }}
            loading="lazy"
          />
          <figcaption className="text-xs text-[#6b5535] italic text-center py-2.5 px-4 bg-[#f8f1e3] border-t border-[#c8b89a]">
            Song of the Angels, William-Adolphe Bouguereau (1881). The peace that meditation reveals. Public domain.
          </figcaption>
        </figure>

        {/* ── The Essence & Ecstasy ────────────────────────────────────────────
            The mystical fruit of genuine inner stillness.
        ──────────────────────────────────────────────────────────────────────── */}
                ...
                <figure className="flex flex-col items-center gap-3">
                  <div className="overflow-hidden rounded-sm shadow-lg border border-[#c8b89a] w-full">
                    <img
                      ...
                      alt="William Blake's Jacob's Dream: Jacob asleep at the base of a radiant ladder ascending to heaven with angels - an image of the meditating consciousness ascending from earth to the divine."
                      className="block w-full h-auto"
                      loading="lazy"
                    />
                  </div>
                  <figcaption className="text-xs text-[#6b5535] italic text-center leading-relaxed">
                    Jacob's Dream, William Blake (c. 1805). The soul ascending in inner stillness. British Museum. Public domain.
                  </figcaption>
                </figure>
              </div>
            </div>
        ...
        {/* ── The Method ───────────────────────────────────────────────────────
            Pratyahara and the technique of working with mental visitors.
        ──────────────────────────────────────────────────────────────────────── */}
        <section className="py-20 px-4 bg-[#f8f1e3] fade-section" aria-labelledby="method-heading">
          <div className="max-w-3xl mx-auto">
            ...
            {/* The polarity teaching - visually highlighted */}
        ...
        {/* ── The Two Principles ───────────────────────────────────────────────
            The distillation of the entire technique into two principles.
        ──────────────────────────────────────────────────────────────────────── */}
        ...
        {/* ── Practical Guidance ───────────────────────────────────────────────
            How to actually sit and practice - concrete instruction.
        ──────────────────────────────────────────────────────────────────────── */}
        ...
        <section className="py-20 px-4 bg-[#faf6ef] fade-section" aria-label="Join our classes">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-base text-[#4a3a26] mb-8 leading-relaxed max-w-lg mx-auto">
              Our weekly meditation classes are open to all - complete beginners and experienced practitioners alike.
              We teach the practical Gnostic techniques described here, with personal guidance and a welcoming community.
