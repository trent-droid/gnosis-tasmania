...
export const ARTICLES = [
  ...
  // ── 1 ──────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'Central to the Gnostic understanding is the recognition that ordinary human consciousness is not genuinely awake. This is not a pessimistic statement but a liberating one, because it identifies what needs to change and makes the work possible. Within each person there exists what the tradition calls the Essence or Buddhata: a pure inner consciousness that is the seed of genuine spiritual awakening. This Essence is not created by spiritual practice; it is already present, already real. But in the ordinary condition of human existence, it sleeps.',
      ...
      },
      {
        ...
        paragraphs: [
          'The Gnostic tradition rests on four foundational pillars: science, philosophy, art, and mysticism. This fourfold structure gives it unusual completeness. Where systems of knowledge often develop only one or two of these dimensions, the Gnostic path integrates all four into a unified whole that addresses every major human faculty.',
      ...
      },
      {
        ...
        paragraphs: [
          'The central teaching of Gnosis concerns what the human being actually is. The tradition distinguishes three fundamental dimensions of the person. The personality is formed through education, culture, and life experience and belongs to a single lifetime. The Essence or soul is the consciousness itself, deeper and more enduring than the personality, and it carries the pattern of the soul\'s development across many lives. And the Being is the innermost spiritual reality, the divine spark at the very centre of the individual, which the tradition sometimes calls the Father, the Real Self, or the inner God.',
          ...
          'This is why the Gospel of Luke records the words: "The Kingdom of Heaven is within you." The Gnostic tradition understands this literally. The heaven spoken of in the mystical scriptures is not a geographical location but an inner state of consciousness that is latent within every human being and can be realised through dedicated and sincere practice.',
        ],
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'H.P. Blavatsky, who devoted her life to revealing the common ground beneath the world\'s spiritual traditions, articulated this recognition in a motto that has remained a touchstone for seekers ever since. The Gnostic path is not about religious affiliation but about direct encounter with truth itself, an encounter that every authentic tradition has made possible in its own way.',
        ],
  ...
  // ── 2 ──────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'The death spoken of in the Gnostic tradition is not physical death but the progressive dissolution of the psychological ego. The ego, in this context, does not refer simply to arrogance or selfishness in the everyday sense. It refers to the entire structure of habitual psychological patterns that together constitute our ordinary sense of self: the fears, vanities, desires, resentments, and mechanical reactions that respond automatically to the circumstances of life and leave the deeper consciousness trapped within them.',
          'This dissolution is not achieved through willpower or moral effort alone. It requires a specific and precise process: first, the clear observation of an ego-state as it actually manifests in present experience; second, genuine comprehension of the nature and psychological roots of that state; and third, the sincere appeal to the inner divine force for assistance in its disintegration. This is not a process of self-criticism or self-punishment but of clear seeing and genuine letting go.',
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The second phase is comprehension: a genuine understanding of the nature of the ego-state, its psychological roots, the fear or unmet need at its origin, and the way it distorts both perception and behaviour. This comprehension is not purely intellectual. It requires a quality of inner honesty and willingness to see oneself clearly that most people find uncomfortable at first but which becomes progressively liberating as the practice deepens. Suppression and comprehension are entirely different things: suppression pushes a pattern underground where it continues operating invisibly, while genuine comprehension dissolves the energy that sustains it.',
          'The third phase involves appealing to what the tradition calls the Divine Mother: the feminine, receptive, and compassionate aspect of the inner divine principle, which is understood as the force genuinely capable of disintegrating the ego-states that have been observed and comprehended. This step acknowledges that the personal will, while entirely necessary for observation and comprehension, is not sufficient on its own to accomplish the dissolution of deeply conditioned psychological patterns. The personal effort opens the door; the inner divine force does the actual work of dissolution.',
        ],
  ...
  // ── 4 ──────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'The Gnostic tradition offers a practical psychological map that greatly assists the practice of self-observation. According to this map, the human being has three distinct centres or "brains," each of which processes experience in its own way and generates its own characteristic states. The intellectual brain thinks and reasons. The emotional brain feels and intuits. The motor-instinctive-sexual brain governs bodily movement, instinct, physical sensation, and the vital creative energy.',
  ...
  // ── 5 ──────────────────────────────────────────────────────────────────────
  {
    ...
    date: '2026-05-23',
    readTime: '10 min read',
    intro: 'Meditation occupies a central place in the Gnostic tradition, not primarily as a technique for relaxation or stress management, though it may produce these results as secondary benefits, but as a precise inner science capable of leading the sincere practitioner through progressively deeper states of consciousness toward direct inner knowledge. The tradition describes this science in terms of a sequence of stages: relaxation, concentration, meditation proper, and samadhi. Understanding these stages and their relationship to one another provides an essential foundation for anyone wishing to establish a genuine and effective practice. Meditation without this understanding tends to plateau; with it, the practice deepens steadily over time.',
    sections: [
      {
      ...
      },
      {
        ...
        paragraphs: [
          'The Gnostic tradition places considerable emphasis on the use of sacred sounds, called mantras, as practical tools for meditation. A mantra is not merely a word or phrase repeated mechanically for a psychological effect. In the Gnostic understanding, certain sounds carry intrinsic vibrational properties that, when vocalised or internally sounded with genuine intention and correct technique, have real effects on the physical, vital, and psychic bodies of the practitioner.',
          ...
          'The tradition also uses specific mantras for particular purposes: for the development of the chakras, for protection during the astral state, for healing, and for devotional connection with the inner divine forces. These are practical tools rather than merely ceremonial ones, and students who work with them sincerely and consistently over time invariably report real and verifiable effects on the quality of their inner life and the depth of their meditative experience.',
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The mantra FARAON, among others taught in the tradition, is used in this way: prolonged, relaxed internal vocalisations performed as the body relaxes and the boundary between waking and sleeping approaches. The intention is not to prevent sleep but to remain sufficiently aware during the transition to experience the separation of the astral body as a conscious event rather than a lapse into unconsciousness.',
      ...
      },
      {
        ...
        paragraphs: [
          'Not every dream experience has equal significance for inner work. The tradition distinguishes between ordinary dreams generated by the activity of the subconscious mind, which represent the mental and emotional material that the personal psychology is processing, and genuine astral experiences in which the consciousness encounters real dimensions of inner reality. Learning to distinguish between these categories is part of the maturing practitioner\'s development.',
          ...
          'The tradition also speaks of the possibility of encounters with the inner Being, the Real Self, in the astral dimension. These encounters, when they occur, have a quality of absolute reality and inner authority that makes them among the most transformative experiences available to the sincere student. They rarely occur on demand but tend to arise when the student has been working consistently and sincerely over a sustained period and when genuine inner preparation has been made.',
        ],
  ...
  // ── 7 ──────────────────────────────────────────────────────────────────────
  {
    ...
    image: artBlakeImg,
    imageAlt: 'William Blake, Jacob\'s Ladder (c. 1805), depicting luminous figures ascending between earth and heaven, one of history\'s most enduring images of the soul\'s upward journey',
    imagePosition: 'center top',
    date: '2026-05-23',
    readTime: '10 min read',
    ...
    sections: [
      {
        ...
        paragraphs: [
          'In the Gospel of Matthew, two roads are described: "Enter through the narrow gate. For wide is the gate and broad is the road that leads to destruction, and many enter through it. But small is the gate and narrow the road that leads to life, and only a few find it." In the esoteric reading that the Gnostic tradition offers, the broad road represents the path of mechanical existence: the unconscious drift through life in a state of habitual reactivity, identification with transient pleasures and aversions, and sleep with respect to the deeper dimensions of the self.',
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The existence and accessibility of this inner guidance is one of the most practically important teachings of the Gnostic tradition. It means that the student is never truly alone in the work, and that the path, however demanding it may be, is not navigated entirely by the personal intelligence. The inner Master knows the student\'s level, condition, and genuine need with a precision that no outer teacher can match. Sincere inner prayer to the Real Being, practised consistently, gradually opens the channel through which this guidance becomes perceptible.',
        ],
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'Understanding this reality does not require accepting it on faith. The Gnostic tradition provides practical methods for directly investigating the continuity of one\'s own soul across time, and the discoveries that arise from genuine practice in this area are among the most personally significant a student can make.',
        ],
  ...
  // ── 9 ──────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'In the Gnostic tradition, the role of the instructor is that of a fellow student who has spent more time on the path and who is willing to share what they have understood, practised, and verified through direct experience. The Gnostic instructor does not claim spiritual authority based on institutional appointment or personal charisma but offers their understanding in a spirit of genuine service and with a clear recognition that genuine wisdom comes ultimately from the inner Being rather than from any outer teacher.',
          ...
          'The relationship between instructor and student in the Gnostic tradition is warm and genuinely supportive, but it is not one of dependence. The goal is always to develop in the student the genuine inner capacities that will allow them to hear the instruction of the inner Master directly, which is the only instruction that can fully accompany the student through every stage of the path.',
        ],
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'Most people leave a first class with something quietly different from what they arrived with: a question that has come alive, a quality of attention that feels more present than usual, or a sense that what is being offered here is substantive and real. This quality is not manufactured; it is the natural result of sincere people gathering around genuine teaching. If that is your experience, the tradition invites you to come again and to take it further.',
  ...
  // ── 11 ─────────────────────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          'The creative energy is understood in the Gnostic tradition as the most concentrated and potent expression of the vital force in the human organism. It is not a lower instinct to be suppressed or indulged mechanically but a sacred power that can be consciously transformed into fuel for spiritual development. This process of transformation is called transmutation: the conscious redirection of the sexual energy upward through the spinal column rather than allowing it to discharge and disperse as happens in ordinary mechanical sexuality.',
          'This principle underlies what the tradition calls the Arcanum A.Z.F., the practice in which the sacred encounter between husband and wife becomes the occasion for a deep inner work. The key distinction is between ordinary sexuality, in which the creative force is discharged and lost to the work of inner development, and this sacred approach, in which the same energy is retained, consciously directed, and transformed into what the tradition calls the sacred fire: the Kundalini or inner serpent that rises through the spinal column and activates the inner centres as it ascends.',
      ...
      },
      {
        ...
        paragraphs: [
          'Chastity in the Gnostic tradition does not mean sexual abstinence or the suppression of the creative force. This is a crucial distinction. The tradition is clear that complete repression of the sexual energy is as harmful to inner development as its mechanical dissipation. Chastity, in the Gnostic sense, refers to a specific attitude and practice: the treatment of the creative force with the reverence it deserves, and its conscious use in accordance with the purposes of genuine inner development rather than its mechanical squandering through unconscious habit.',
          'For those within the context of a committed, loving relationship, chastity means bringing conscious intention and genuine mutual respect to the sexual dimension of the relationship, and learning to work with the creative energy in the way the tradition describes. For those who are not in such a relationship, chastity means the transmutation of the sexual energy through specific practices of meditation, mantra, and inner prayer, rather than its discharge through mechanical habit.',
    ...
    keyPoints: [
      'The creative force is sacred in the Gnostic tradition: neither an obstacle to overcome nor a mere instinct',
    ...
    sections: [
      {
        ...
        paragraphs: [
          ...
          'The Gnostic tradition makes clear that the capacity for genuine, unconditional giving is itself a fruit of inner work rather than a starting point. Most people, in their ordinary psychological state, give conditionally: with expectation, with a sense of personal cost, and with an inner accounting of what has been offered and what has been received in return. This conditional quality is not a moral failure but a characteristic expression of the ego in its ordinary state. The inner work does not condemn it but progressively dissolves the ego-patterns that sustain it, making room for a quality of generosity that the ego, by its nature, cannot manufacture.',
        ],
      ...
      },
      {
        ...
        paragraphs: [
          'The tradition offers a clear explanation of why service is not merely ethically desirable but structurally necessary for genuine spiritual development. The ego, in its fundamental movement, contracts and separates. It accumulates, defends, and insists on the primacy of its own perspective and needs. The inner work of dissolution and development works consistently against this contraction through the practices of self-observation, meditation, and ego dissolution.',
      ...
      },
      {
        ...
        paragraphs: [
          'The grand gesture of sacrifice is relatively rare in most people\'s lives, and the Gnostic tradition does not primarily concern itself with grand gestures. What it asks for, consistently and practically, is the genuine quality of small, daily acts of service: the moment when one sets aside personal preference to attend genuinely to another person\'s need, the choice to offer honesty rather than comfortable flattery, the patient extension of care to someone in difficulty when it would be easier to look away.',
