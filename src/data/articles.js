    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'The community dimension of this work is practically important. The shared vocabulary for inner experience that a consistent study group develops makes it easier for students to describe and reflect on their inner experiences in a way that clarifies rather than distorts them. The guidance of an experienced instructor who has worked with these practices over many years helps students distinguish between the significant and the merely interesting, and provides practical support for the specific techniques that the tradition offers for this dimension of inner development. The door to these classes is open to anyone who approaches the work with genuine sincerity and a willingness to apply what is taught.',
        ],
      },
    ],
    keyPoints: [
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          'This requires a quality of relationship that is not always easy to find or sustain: one in which both parties are genuinely committed to honesty, mutual care, and the kind of respect that makes real feedback possible without becoming an instrument of harm. The Gnostic tradition regards this kind of mutually developmental relationship as one of the highest expressions of the third factor of conscious awakening, the sacrifice for humanity that begins with the people most immediately and concretely present in one\'s own daily life.',
        ],
      },
      {
