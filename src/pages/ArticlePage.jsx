      ...
      <section className="py-16 px-4 bg-[#2a1e12] fade-section">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-[#c8b89a] leading-relaxed mb-8">
            Reading opens the door. The living teaching unfolds in practice, in community, and in the inner work of day-to-day life. We meet weekly in Hobart and Launceston — all are welcome.
          </p>
