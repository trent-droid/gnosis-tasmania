...
import { GoldRule, ArtBanner } from './components/ui.jsx'
...
import artRosariumKingQueenImg   from './assets/art_rosarium_king_queen.jpg'
import artKhunrathRebisImg       from './assets/art_khunrath_rebis.jpg'
import artFluddSummumImg         from './assets/art_fludd_summum.jpg'
import artRosariumConjunctionImg from './assets/art_rosarium_conjunction.jpg'
...
const PARTS = [
  {
    ...
    art: {
      ...
      alt: 'Vitruvian Man by Leonardo da Vinci: the ideal human proportions inscribed in circle and square, illustrating the correspondence between the human microcosm and the divine macrocosm.',
      caption: 'Vitruvian Man, Leonardo da Vinci (c. 1490). CC BY-SA 3.0.',
  ...
  },
  {
    ...
    art: {
      ...
      caption: 'Integrae Naturae Speculum, Robert Fludd (1617). CC BY 4.0, Wellcome Collection.',
  ...
  },
  {
    ...
    art: {
      src: artRosariumKingQueenImg,
      alt: 'Rosarium Philosophorum woodcut - the King and Queen, Sun and Moon, standing together above the waters: an image of the cosmic law of polarity that governs all cycles of birth, death, and return.',
      caption: 'Rosarium Philosophorum (c. 1550). CC BY 4.0, Wellcome Collection.',
  ...
  },
  {
    ...
    art: {
      ...
      alt: "Heinrich Khunrath's alchemical Rebis - the androgynous figure representing the solar and lunar principles united within creation, directly related to the Kabbalistic Tree of Life and the seven cosmoses.",
      caption: 'The Hermaphrodite / Rebis, Heinrich Khunrath, Amphitheatrum Sapientiae Aeternae (1595). Public domain.',
  ...
  },
  {
    ...
    art: {
      ...
      caption: 'Summum Bonum, Robert Fludd (c. 1629). Public domain.',
  ...
  },
  {
    ...
    art: {
      src: artRosariumConjunctionImg,
      alt: 'Rosarium Philosophorum - the holy conjunction: King and Queen united, representing the final alchemical marriage that precedes initiation, the liberation of the soul, and the dawn of the Initiatic Path.',
      caption: 'The Holy Conjunction, Rosarium Philosophorum (c. 1550). CC BY 4.0, Wellcome Collection.',
  ...
  return (
    <div className="min-h-screen bg-[#faf6ef] text-[#3a2f1f]">
      ...
      <main>
        ...
        {/* ── Hero ────────────────────────────────────────────────────────────
            School of Athens - the gathering of great teachers and seekers.
        ──────────────────────────────────────────────────────────────────── */}
        <header className="relative flex flex-col items-center justify-center text-center px-4 pt-16 min-h-[55vh] overflow-hidden" aria-label="Course hero">
          <div className="absolute inset-0" aria-hidden="true">
            <div
              ...
              style={{ backgroundImage: `url(${heroSchoolAthensImg})`, backgroundPosition: 'center 30%' }}
            />
          ...
          >
            <div className="max-w-6xl mx-auto">
              ...
              <ArtBanner
                src={part.art.src}
                alt={part.art.alt}
                caption={part.art.caption}
                objectPosition={part.art.objectPosition}
              />
        ...
        <section className="py-20 px-4 bg-[#1c1409] fade-section" aria-label="Join a class">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-sm text-[#c8b89a] mb-8 leading-relaxed">
              We welcome sincere seekers of all backgrounds. Reach out to register your interest
              or ask any questions - there are no obligations and no pressure.
            </p>
